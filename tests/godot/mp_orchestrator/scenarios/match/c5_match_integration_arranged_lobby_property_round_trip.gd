...
const SCENARIO_ID: String = "match.integration.arranged_lobby_property_round_trip"
const SCENARIO_NAME: String = "Arranged lobby property round trip"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_integration_arranged_lobby_property_round_trip(orch)
