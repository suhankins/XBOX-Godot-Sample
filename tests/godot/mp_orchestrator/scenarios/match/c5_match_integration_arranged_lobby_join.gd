...
const SCENARIO_ID: String = "match.integration.arranged_lobby_join"
const SCENARIO_NAME: String = "Matched clients join arranged lobby"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_integration_arranged_lobby_join(orch)
