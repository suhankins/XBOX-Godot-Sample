...
const SCENARIO_ID: String = "match.ticket.completion.metadata_present"
const SCENARIO_NAME: String = "Completed ticket exposes metadata"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_ticket_completion_metadata_present(orch)
