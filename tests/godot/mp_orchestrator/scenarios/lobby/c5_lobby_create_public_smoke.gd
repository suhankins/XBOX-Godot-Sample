...
const SCENARIO_ID: String = "lobby.create.public.smoke"
const SCENARIO_NAME: String = "Public lobby create snapshot"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_create_public_smoke(orch)
