...
const SCENARIO_ID: String = "lobby.create.with_initial_member_properties"
const SCENARIO_NAME: String = "Create with initial member properties"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_create_with_initial_member_properties(orch)
