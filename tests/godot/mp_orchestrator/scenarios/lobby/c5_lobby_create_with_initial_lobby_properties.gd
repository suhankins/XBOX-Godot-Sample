...
const SCENARIO_ID: String = "lobby.create.with_initial_lobby_properties"
const SCENARIO_NAME: String = "Create with initial lobby properties"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_create_with_initial_lobby_properties(orch)
