...
const SCENARIO_ID: String = "lobby.properties.set.unjoined_lobby"
const SCENARIO_NAME: String = "Set lobby properties after leaving is rejected"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_properties_set_unjoined_lobby(orch)
