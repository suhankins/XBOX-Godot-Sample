...
const SCENARIO_ID: String = "lobby.leave.rejoin_after_leave"
const SCENARIO_NAME: String = "Client can rejoin after leaving"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_leave_rejoin_after_leave(orch)
