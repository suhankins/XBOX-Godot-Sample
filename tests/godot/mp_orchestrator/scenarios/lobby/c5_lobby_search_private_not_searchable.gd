...
const SCENARIO_ID: String = "lobby.search.private.not_searchable"
const SCENARIO_NAME: String = "Private lobby is not searchable"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_search_private_not_searchable(orch)
