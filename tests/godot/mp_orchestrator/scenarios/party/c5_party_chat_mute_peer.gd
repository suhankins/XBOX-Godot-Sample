...
const SCENARIO_ID: String = "party.chat.mute.peer"
const SCENARIO_NAME: String = "Muting peer suppresses chat"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_chat_mute_peer(orch)
