...
const SCENARIO_ID: String = "party.chaos.guest_kill.peer_disconnected"
const SCENARIO_NAME: String = "Guest kill disconnects peer"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_chaos_guest_kill_peer_disconnected(orch)
