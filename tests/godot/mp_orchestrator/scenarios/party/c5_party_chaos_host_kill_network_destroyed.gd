...
const SCENARIO_ID: String = "party.chaos.host_kill.network_destroyed"
const SCENARIO_NAME: String = "Host kill destroys guest network"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_chaos_host_kill_network_destroyed(orch)
