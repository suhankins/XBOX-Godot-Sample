...
const SCENARIO_ID: String = "party.rpc.round_trip.post_join_first_message"
const SCENARIO_NAME: String = "First post-join RPC round trip"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_rpc_round_trip_post_join_first_message(orch)
