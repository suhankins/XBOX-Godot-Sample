...
const SCENARIO_ID: String = "party.network.join.smoke"
const SCENARIO_NAME: String = "Guest joins Party network"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_network_join_smoke(orch)
