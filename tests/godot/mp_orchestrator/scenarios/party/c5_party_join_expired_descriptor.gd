...
const SCENARIO_ID: String = "party.join.expired_descriptor"
const SCENARIO_NAME: String = "Expired Party descriptor rejected"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_join_expired_descriptor(orch)
