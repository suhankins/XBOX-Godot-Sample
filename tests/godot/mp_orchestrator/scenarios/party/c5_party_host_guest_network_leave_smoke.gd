...
const SCENARIO_ID: String = "party.network.leave.smoke"
const SCENARIO_NAME: String = "Guest leaves Party network"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_network_leave_smoke(orch)
