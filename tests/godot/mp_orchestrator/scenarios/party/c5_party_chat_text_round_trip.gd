...
const SCENARIO_ID: String = "party.chat.text.round_trip"
const SCENARIO_NAME: String = "Party text chat round trip"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_party_chat_text_round_trip(orch)
